const projectData = [
  {
    ...
    fullDesc: "",
    technologies: ["HTML","SASS","Javascript","React","Amazon Web Services (AWS)", "Git"],
  ...
  },
  {
    ...
    fullDesc: "",
    technologies: ["HTML","CSS","Javascript","Python","Django","PostgreSQL","jQuery", "Amazon Web Services (AWS)","Travis CI", "Heroku","Git"],
  ...
  },
  {
    ...
    fullDesc: "",
    technologies: ["HTML","CSS","Javascript","Python","Flask","MongoDB","jQuery", "Amazon Web Services (AWS)","Travis CI","Heroku","Git"],
