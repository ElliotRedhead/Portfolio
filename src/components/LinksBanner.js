...
const LinksBanner = () => {
  return(
    <>
      <a href="http://www.github.com/elliotredhead" target="_blank" rel="noreferrer">
      ...
      <a href="https://elliot-portfolio.s3.eu-west-2.amazonaws.com/Elliot_Redhead_CV.pdf" target="_blank" rel="noreferrer">
